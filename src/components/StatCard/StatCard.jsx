                        ...
                        <tbody>
                            {object && Object.keys(object).map((key, index, arr) => {
                                ...
                                return (
                                  ...
                                  >
                                    <td className="p-2 font-medium text-slate-600 pl-3">
                                      {key}
                                    </td>
                                    <td className="p-2 pr-3 text-right text-slate-500">
                                      {object[key].value} {object[key].unit} /{" "}
                                      <span className=''>
                                        {" "}
                                        {object[key].missing} {object[key].unit}{" "}
                                        {" "}
                                      </span>
                                    </td>
                                  </tr>
