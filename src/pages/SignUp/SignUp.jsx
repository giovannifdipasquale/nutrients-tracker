            ...
            <div className="w-full max-w-sm">
                <form onSubmit={handleSubmit} className="bg-white shadow-xl rounded-2xl px-8 pt-8 pb-8 mb-4 border border-slate-100">
                    ...
                    <div className="mb-6">
                        ...
                        <input className="shadow-sm appearance-none border border-slate-300 rounded-lg w-full py-2.5 px-3 text-slate-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Create a password" required />
                    </div>
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-slate-600">
                            ...
                            <Link to="/login" className="font-semibold text-blue-600 hover:text-blue-800 transition">Log in</Link>
                        </p>
                    </div>
                </form>
            </div>
